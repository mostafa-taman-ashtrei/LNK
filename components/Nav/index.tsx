    ...
    return (
        <header
            className={`header top-0 left-0 z-40 flex w-full items-center bg-transparent ${sticky
                ? "!fixed !z-[9999] !bg-white !bg-opacity-80 shadow-sticky backdrop-blur-xl !transition dark:!bg-primary dark:!bg-opacity-70"
                : "absolute"
                }`}
        >
                ...
                <div className="relative -mx-4 flex items-center justify-between">
                    <div className="w-60 max-w-full px-4 xl:mr-12">
                        <Link
                            ...
                            `}
                        >
                            <h1 className="font-extrabold text-2xl leading-tight text-black dark:text-white ">
