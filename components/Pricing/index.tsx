      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-2">
          <PricingBox
            ...
            subtitle="A plan for everyone, you get what you need without paying anything."
            comingSoon={false}
          >
          ...
          <PricingBox
            packageName="Plus"
            price={isMonthly ? "4.99" : "59.88"}
            duration={isMonthly ? "mo" : "yr"}
            subtitle="A plan for the pros who want to take things to the next level."
            comingSoon={true}
          >
            <OfferList text="Graph View" status="active" />
            <OfferList text="Linking URLS" status="active" />
